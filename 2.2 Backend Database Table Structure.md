...
* PK: player (references Player.user_pk_id)
* FK: player (references Player.user_pk_id)
```
...
![PokerBackend_ERD_v5](https://github.com/user-attachments/assets/bc2fae6f-555f-475f-9b86-3f1ece865e17)
