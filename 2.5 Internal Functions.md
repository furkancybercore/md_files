...
>>|-------------|----------|----------|---------------------------------------------------------|------------------------------------------------------------------|
>>| `init_data` | `string` | Yes      | Raw URL-encoded initData string from Telegram WebApp. | Client request. <br> Example: [`views.verify_telegram_user`](#️-verify_telegram_user) |
>>
>>**Return:**
>>
...
>>**Return:**
>>
>> - `dict`: A dictionary containing the user's data (`id`, `first_name`, `last_name`, etc.) if parsing is successful. from client request - `None`: Otherwise.
>>
>>**Function Definition:**
>>```python
>># app_core/poker_event/utils.py
