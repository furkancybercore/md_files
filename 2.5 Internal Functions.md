...
>>|-------------|----------|----------|---------------------------------------------------------|------------------------------------------------------------------|
>>| `init_data` | `string` | Yes      | Raw URL-encoded initData string from Telegram WebApp. | [`require_telegram_self`](#️-require_telegram_self) (`request.headers` or `request.data`), [`views.verify_telegram_user`](#️-verify_telegram_user) (`request.data`) |
>>
>>**Return:**
>>
