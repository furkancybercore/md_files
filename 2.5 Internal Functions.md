...
>>|-------------|----------|----------|---------------------------------------------------------|------------------------------------------------------------------|
>>| `init_data` | `string` | Yes      | Raw URL-encoded initData string from Telegram WebApp. | `request.data['initData']` or `request.headers['initData']` in [`require_telegram_self`](#️-require_telegram_self), [`views.verify_telegram_user`](#️-verify_telegram_user) |
>>
>>**Return:**
>>
...
>>| Parameter   | Type     | Required | Description                                             | Origin                                                           |
>>|-------------|----------|----------|---------------------------------------------------------|------------------------------------------------------------------|
>>| `init_data` | `string` | Yes      | Raw URL-encoded initData string from Telegram WebApp. | [`views.verify_telegram_user`](#️-verify_telegram_user) |
>>
>>**Return:**
>>
>>`dict`: A dictionary containing the user's data (`id`, `first_name`, `last_name`, etc.) if parsing is successful. 
>>`None`: Otherwise.
>>
>>**Function Definition:**
>>```python
...
>>| Parameter   | Type     | Required | Description                                             | Origin                                                           |
>>|-------------|----------|----------|---------------------------------------------------------|------------------------------------------------------------------|
>>| `init_data` | `string` | Yes      | Raw URL-encoded initData string from Telegram WebApp. | [`require_telegram_self`](#️-require_telegram_self), [`views.verify_telegram_user`](#️-verify_telegram_user) |
>>
>>**Return:**
>>
>>`Big int` or `None`: The user's Telegram ID if found and valid, `None` otherwise.
>>
>>**Function Definition:**
>>```python
>># app_core/poker_event/utils.py
...
>>**Return:**
>>
>>`int` or `None`: The Unix timestamp of the authentication if found, `None` otherwise.
>>
>>**Function Definition:**
>>```python
>># app_core/poker_event/utils.py
...
>>**Return:**
>>
>> The wrapped function's `Response`.
>>
>>**Function Definition:**
>>```python
