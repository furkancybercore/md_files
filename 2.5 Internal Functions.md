...
>>|-----------|-----------|----------|--------------------------------------------------------|
>>| `raw_key` | `string`  | Yes      | The plain-text authentication key to be hashed and stored. |
>>
>>**Return:**
>>
>>`None`
...
>>| Parameter | Type      | Required | Description                                                    |
>>|-----------|-----------|----------|----------------------------------------------------------------|
>>| `raw_key` | `string`  | Yes      | The plain-text authentication key to validate against the stored hash. |
>>
>>**Return:**
>>
...
>    *Note: While this method exists, the `VerifyUserSerializer.save` method currently updates the timestamp directly.*
>
>>**Parameters:**
>>
>>| Parameter | Type      | Required | Description                                   |
>>|-----------|-----------|----------|-----------------------------------------------|
>>| `self`    | `Player`  | Implicit | The instance of the Player model itself.        |
>>
>>**Return:** 
>>
>>`None`
...
>>| Parameter | Type   | Required | Description              |
>>|-----------|--------|----------|--------------------------|
>>| `self`    | `Serializer` | Implicit | The serializer instance. |
>>| `data`    | `dict` | Yes      | Raw input data (from `request.data`). |
>>
>>**Return:**
>>
...
>>|-----------|--------|----------|--------------------------|
>>| `self`    | `Serializer` | Implicit | The serializer instance. |
>>| `attrs`   | `dict` | Yes      | Dictionary of validated data from `to_internal_value`. |
>>
>>**Return:**
>>
...
>>|----------------|------------------|----------|------------------------------------------------|
>>| `self`         | `Serializer`     | Implicit | The serializer instance.                       |
>>| `current_date` | `date`/`datetime`| Yes      | The starting date for calculation.             |
>>| `regularity`   | `string`         | Yes      | The pattern ('weekly', 'fortnightly', 'monthly'). |
>>| `multiplier`   | `int`            | Yes      | The number of intervals to add.                |
>>
>>**Return:**
>>
...
>>|---------------|-------------------|----------|---------------------------------------------------|
>>| `self`        | `Serializer`      | Implicit | The serializer instance.                          |
>>| `regularity`  | `string`          | Yes      | The repetition pattern.                           |
>>| `base_game`   | `Game`            | Yes      | The initial game instance to base copies on.      |
>>| `game_date`   | `date`/`datetime` | Yes      | The starting date of the initial game.          |
>>| `game_data`   | `dict`            | Yes      | Dictionary containing data for creating new games. |
>>
>>**Return:**
>>
...
>>|-----------|--------|----------|--------------------------|
>>| `self`    | `Serializer` | Implicit | The serializer instance. |
>>| `obj`     | `Game` | Yes      | The Game model instance.  |
>>
>>**Return:**
>>
...
>>|------------------|--------|----------|--------------------------|
>>| `self`           | `Serializer` | Implicit | The serializer instance. |
>>| `validated_data` | `dict` | Yes      | Validated data for creating the game. |
>>
>>**Return:**
>>
...
>>|------------------|--------|----------|--------------------------|
>>| `self`           | `Serializer` | Implicit | The serializer instance. |
>>| `validated_data` | `dict` | Yes      | Validated data containing `telegram_id` and `game_id`. |
>>
>>**Return:**
>>
...
>>| Parameter | Type   | Required | Description              |
>>|-----------|--------|----------|--------------------------|
>>| `self`    | `Serializer` | Implicit | The serializer instance (context contains `game`). |
>>| `obj`     | `Player`| Yes      | The Player model instance. |
>>
>>**Return:**
>>
...
>>**Return:**
>>
>>Serialized data (`list` of `dict`) for players who joined the game, using `JoinedPlayerSerializer`.
>>
>>**Function Definition:**
>>```python
>># app_core/poker_event/serializers.py
...
>>| Parameter | Type   | Required | Description              |
>>|-----------|--------|----------|--------------------------|
>>| `self`    | `Serializer` | Implicit | The serializer instance (context contains `player`). |
>>| `obj`     | `Game` | Yes      | The Game model instance.  |
>>
>>**Return:**
>>
...
>>**Return:**
>>
>>Serialized data (`list` of `dict`) for games the player joined, using `JoinedGameSerializer`.
>>
>>**Function Definition:**
>>```python
>># app_core/poker_event/serializers.py
...
>>| Parameter | Type | Required | Description |
>>|-----------|------|----------|-------------|
>>| `var_name` | `str` | Yes | The name of the environment variable. |
>>| `default` | `any` | No | The default value to return if the variable is not found. |
>>
>>**Return:**
>>
...
>>| Parameter | Type      | Required | Description              |
>>|-----------|-----------|----------|--------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP request object containing `initData`. |
>>
>>**Return:**
>>
...
>>| Parameter | Type      | Required | Description              |
>>|-----------|-----------|----------|--------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP GET request object. |
>>
>>**Return:**
>>
...
>>| Parameter | Type      | Required | Description              |
>>|-----------|-----------|----------|--------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP POST request object with game data. |
>>
>>**Return:**
>>
...
>>| Parameter | Type      | Required | Description              |
>>|-----------|-----------|----------|--------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP POST request object with `telegram_id` and `game_id`. |
>>
>>**Return:**
>>
...
>>|-----------|-----------|----------|--------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP GET request object. |
>>| `game_id` | `int`     | Yes      | The ID of the game to retrieve (from URL). |
>>
>>**Return:**
>>
...
>>| Parameter | Type      | Required | Description              |
>>|-----------|-----------|----------|--------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP POST request object with `telegram_id`. |
>>
>>**Return:**
>>
...
>>| Parameter | Type   | Required | Description              |
>>|-----------|--------|----------|--------------------------|
>>| `self`    | `AppConfig` | Implicit | The AppConfig instance. |
>>
>>**Return:**
>>
>>`None` (implicitly).
...
>>| Parameter | Type | Required | Description |
>>|-----------|------|----------|-------------|
>>| None      | N/A  | N/A      | Uses `sys.argv` internally. |
>>
>>**Return:**
>>
