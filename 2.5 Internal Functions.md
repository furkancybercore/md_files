...
>>|-------------|----------|----------|---------------------------------------------------------|------------------------------------------------------------------|
>>| `init_data` | `string` | Yes      | Raw initData from Telegram WebApp. | Example: Received by API handlers like [`views.verify_telegram_user`](#️-verify_telegram_user) from client request. |
>>
>>**Return:**
>>
...
>>| Parameter   | Type     | Required | Description                                             | Origin                                                           |
>>|-------------|----------|----------|---------------------------------------------------------|------------------------------------------------------------------|
>>| `init_data` | `string` | Yes      | Raw URL-encoded initData string from Telegram WebApp. | Example: Received by API handlers like [`views.verify_telegram_user`](#️-verify_telegram_user) from client request. |
>>
>>**Return:**
>>
