...
>>>| Parameter | Type   | Required | Description                | Origin                                                                 |
>>>|-----------|--------|----------|----------------------------|------------------------------------------------------------------------|
>>>| `self`    | `Serializer` | Implicit | The serializer instance.   | Method call within `CreateGameSerializer.create`                       |
>>>| `regularity` | `string` | Yes | The regularity setting. | `validated_data["regularity"]` in [`create`](#️-create-creategameserializer)     |
>>>| `base_game` | `Game` | Yes | The original game object. | Result of `Game.objects.create` in [`create`](#️-create-creategameserializer) |
>>>| `game_date` | `date` | Yes | The original game date. | `validated_data["game_date"]` in [`create`](#️-create-creategameserializer)    |
...
>>>| `regularity` | `string` | Yes | The regularity setting (choices defined in [`CreateGameSerializer`](#create-game-serializer)). | Parameter passed to method (e.g., from `schedule_future_game_sessions`) |
>>>
>>>**Return:**
>>>
...
>>>|-----------|--------|----------|----------------------------|----------------------------------------------------------------------------|
>>>| `self`    | `Serializer` | Implicit | The serializer instance.   | Method call                                                                |
>>>| `current_date` | `date` | Yes | The date to calculate from. | Parameter passed to method (e.g., `game_date` in `schedule_future_game_sessions`) |
>>>| `regularity` | `string` | Yes | The regularity setting. | Parameter passed to method (e.g., from `schedule_future_game_sessions`) |
>>>| `multiplier` | `int` | Yes | Which occurrence to calculate. | Iteration counter in `schedule_future_game_sessions`                     |
>>>
>>>**Return:**
>>>
