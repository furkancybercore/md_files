...
>>|-------------|----------|----------|---------------------------------------------------------|------------------------------------------------------------------|
>>| `init_data` | `string` | Yes      | Raw initData from Telegram WebApp. | - [`require_telegram_self`](#️-require_telegram_self) (`request.headers` or `request.data`), <br>- [`views.verify_telegram_user`](#️-verify_telegram_user) (`request.data`) |
>>
>>**Return:**
>>
