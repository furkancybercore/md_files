...
>>|-----------|-----------|----------|-----------------------------------------------------------|---------------------------------------------------------------------|
>>| `raw_key` | `string`  | Yes      | The plain-text authentication key to be hashed and stored. | Telegram `initData` -> [`serializers.VerifyUserSerializer.validate`](#️-validate) |
>>
>>**Return:**
>>
>>`None`
...
>>| Parameter | Type      | Required | Description                                                         | Origin                                                              |
>>|-----------|-----------|----------|---------------------------------------------------------------------|---------------------------------------------------------------------|
>>| `raw_key` | `string`  | Yes      | The plain-text authentication key to validate against the stored hash. | Telegram `initData` -> [`serializers.VerifyUserSerializer.validate`](#️-validate) |
>>
>>**Return:**
>>
