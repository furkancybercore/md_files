...
>>| Parameter | Type      | Required | Description                        | Origin                                                                              |
>>|-----------|-----------|----------|------------------------------------|-------------------------------------------------------------------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP request object.  | [`POST /api/verify-telegram-user/`](2.1 Backend API URL Schema.md#post-apiverify-telegram-user) |
>>
>>**Return:**
>>
>>`Response` object:
...
>>| Parameter | Type      | Required | Description                       | Origin                                                            |
>>|-----------|-----------|----------|-----------------------------------|-------------------------------------------------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP request object. | [`GET /api/players/`](2.1 Backend API URL Schema.md#get-apiplayers) |
>>
>>**Return:**
>>
>>`Response` object:
...
>>| Parameter | Type      | Required | Description                       | Origin                                                                 |
>>|-----------|-----------|----------|-----------------------------------|------------------------------------------------------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP request object with game configuration. | [`POST /api/games/create/`](2.1 Backend API URL Schema.md#post-apigamescreate) |
>>
>>**Return:**
>>
>>`Response` object:
...
>>| Parameter | Type      | Required | Description                       | Origin                                                         |
>>|-----------|-----------|----------|-----------------------------------|----------------------------------------------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP request object. | [`GET /api/games/`](2.1 Backend API URL Schema.md#get-apigames) |
>>
>>**Return:**
>>
>>`Response` object:
...
>>| Parameter | Type      | Required | Description                       | Origin                                                              |
>>|-----------|-----------|----------|-----------------------------------|---------------------------------------------------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP request object with player and game information. | [`POST /api/game/join/`](2.1 Backend API URL Schema.md#post-apigamejoin) |
>>
>>**Return:**
>>
>>`Response` object:
...
>>| Parameter | Type      | Required | Description                       | Origin                                                                   |
>>|-----------|-----------|----------|-----------------------------------|--------------------------------------------------------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP request object. | [`GET /api/games/{game_id}/`](2.1 Backend API URL Schema.md#get-apigamesgame_id) |
...
>>| Parameter | Type      | Required | Description                       | Origin                                                                     |
>>|-----------|-----------|----------|-----------------------------------|----------------------------------------------------------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP request object containing the player's telegram_id. | [`POST /api/hosting-details/`](2.1 Backend API URL Schema.md#post-apihosting-details) |
>>
>>**Return:**
>>
>>`Response` object:
...
>>| Parameter | Type      | Required | Description                       | Origin                                                                     |
>>|-----------|-----------|----------|-----------------------------------|----------------------------------------------------------------------------|
>>| `request` | `Request` | Yes      | The incoming HTTP request object containing the player's telegram_id. | [`POST /api/joining-details/`](2.1 Backend API URL Schema.md#post-apijoining-details) |
>>
>>**Return:**
>>
>>`Response` object:
